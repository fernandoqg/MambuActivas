...
public class ProductRepository implements ProductService {
    ...
    @Override
    public ProductResponseDTO productResponse(String idProduct) {
        ...
        try {
            ResponseEntity<ProductResponseDTO> response = restTemplate.exchange(basePath + "/loanproducts/" + idProduct + "?offset=0&limit=10&paginationDetails=OFF&detailsLevel=FULL", HttpMethod.GET, httpEntity, ProductResponseDTO.class);
